...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `92.6µs` | `1.2ms` |
| [Day 2](./src/bin/02.rs) | `45.6µs` | `44.5µs` |
| [Day 3](./src/bin/03.rs) | `124.6µs` | `7.5ms` |
| [Day 4](./src/bin/04.rs) | `634.5µs` | `807.4ms` |
| [Day 5](./src/bin/05.rs) | `13.2µs` | `5.1s` |
| [Day 6](./src/bin/06.rs) | `349.0ns` | `19.3ms` |
