...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `122.7µs` | `1.2ms` |
| [Day 2](./src/bin/02.rs) | `45.4µs` | `46.6µs` |
| [Day 3](./src/bin/03.rs) | `119.3µs` | `6.9ms` |
| [Day 4](./src/bin/04.rs) | `615.7µs` | `785.2ms` |
| [Day 5](./src/bin/05.rs) | `13.8µs` | `8.0s` |
